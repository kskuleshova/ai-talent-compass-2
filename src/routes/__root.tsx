...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Analyze resumes and compare candidates against vacancy requirements with AI." },
      { property: "og:title", content: "Hirelens — AI Recruiter Assistant" },
    ...
    links: [
      ...
      { rel: "icon", href: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='20' fill='%234f46e5'/><path d='M30 65 L50 25 L70 65' stroke='white' stroke-width='8' fill='none' stroke-linejoin='round'/><circle cx='50' cy='72' r='5' fill='white'/></svg>" },
],
  }),
